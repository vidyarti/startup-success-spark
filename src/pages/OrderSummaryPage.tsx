...
const orderItems = [
  { id: 1, name: "Business Plan Template", price: 29.99, quantity: 1 },
  { id: 2, name: "Marketing Strategy Guide", price: 19.99, quantity: 1 },
  { id: 3, name: "Legal Setup Templates", price: 39.99, quantity: 1 },
];
